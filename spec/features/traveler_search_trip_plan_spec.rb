...
feature 'Traveler search for a trip plan' do
  ...
  scenario 'and view only the correct trip plan' do
    ...
    another_itinerary = Itinerary.create(location: 'São Paulo', season: 'Férias escolares',
                start_date: '01/03/2019', end_date: '01/04/2019',
  ...
  scenario 'and view two plans' do

    trip_plan_one = TripPlan.create(title: 'Mochilão América do Sul',
                start_date: '01/01/2019', end_date: '01/02/2019')

    itinerary_one = Itinerary.create(location: 'São Paulo', season: 'Começo do ano',
                start_date: '01/01/2019', end_date: '01/02/2019',
    ...
    itinerary_two = Itinerary.create(location: 'São Paulo', season: 'Férias escolares',
                start_date: '01/03/2019', end_date: '01/04/2019',
    ...
    itinerary_three = Itinerary.create(location: 'São Paulo', season: 'Começo do ano',
                start_date: '10/01/2019', end_date: '10/03/2019',
                trip_plan: trip_plan_three)
  ...
  scenario 'and only end_date in a range results' do
  ...
  scenario 'and dont found results' do
  ...
  scenario 'Dont acept start_date bigger than end_date' do
